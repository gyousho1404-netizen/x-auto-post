...
def generate_tweet(post_type):
    ...
    if post_type == "blog":
        ...
        prompt = base + "テーマ：デジタル化・AI導入補助金（旧IT導入補助金）の公募案内。第4次締切が8月25日と迫っている。中小企業・小規模事業者向けAI・ITツール導入支援。今から準備しないと間に合わない旨を伝え相談を促す。最適なハッシュタグ2〜3個。絵文字1〜2個。"
    elif post_type == "it_detail":
        prompt = base + "テーマ：デジタル化・AI導入補助金の具体的な内容紹介。補助率最大4/5・最大450万円・対象ソフト（会計・販売管理・AI活用ツールなど）・GビズID取得に2週間かかる点のうち1点を掘り下げて紹介。実用的なトーン。最適なハッシュタグ2〜3個。絵文字1〜2個。"
